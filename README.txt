...
1. Execute SP_air_db_init.sql script first by pressing the execute    button 
   This will generate the required tables for the SP_Air Database

2. Then execute SP_Air_seed.sql next to generate sample data in the    Database
...
# Search Flights
- Direct Flight From Changi Airport --> to Senai International Airport with Depart Date = 27/12/2022
- Return Flight From Senai International Airport --> to Narita Airport with Depart Date = 20/12/2022, Return Date = 22/12/2022

- Transfer Flight from Changi Airport --> San Francisco Airport / Narita Airport --> Senai International Airport with Depart Date = 27/12/2022 , Return Date = 1/1/2023
- Best Transfer Flight from Changi Airport --> Disabled --> Senai International Airport with Depart Date = 27/12/2022 , Return Date = 1/1/2023
